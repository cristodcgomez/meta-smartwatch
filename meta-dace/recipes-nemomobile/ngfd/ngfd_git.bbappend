# Dace vibrator path: ffmemless via cs40l26's FF_PERIODIC sine. We
...
FILESEXTRAPATHS:prepend:dace := "${THISDIR}/ngfd:"

do_install:append:dace() {
    # Dace vibrates through ffmemless only; the droid-vibrator plugin
