...
#       --manifest dace-vkb-modules.lst \
#       --kernel-pkgdir <linux-dace's package/usr/lib/modules/5.15.144/kernel> \
#       --techpack-dir  <linux-dace-modules ipk-extracted root> \
...
# bricks boot at the G logo on dace -- likely CFI / build metadata in
